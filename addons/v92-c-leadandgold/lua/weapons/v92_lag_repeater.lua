...
--	'Repeater'
--	.45-70 Government Winchester Model 1886 Repeater
------------------------------------------------------

AddCSLuaFile( )

SWEP.PrintName = "Winchester Model 1886" -- (String) Printed name on menu
...
SWEP.WeaponName = "v92_lag_repeater" -- (String) Name of the weapon script
...
SWEP.WorldModel = Model("models/jessev92/leadandgold/weapons/repeater_w.mdl") -- (String) World model - w_*
...
SWEP.Primary.ClipSize = 9 -- (Integer) Size of a magazine
SWEP.Primary.DefaultClip = 9 -- (Integer) Default number of ammo you spawn with
