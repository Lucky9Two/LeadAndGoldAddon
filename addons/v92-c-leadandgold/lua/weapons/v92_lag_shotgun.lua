...
SWEP.PrintName = "Double Barrel" -- (String) Printed name on menu
...
SWEP.WeaponName = "v92_lag_shotgun" -- (String) Name of the weapon script
SWEP.WeaponEntityName = SWEP.WeaponName .. "_ent" -- (String) Name of the weapon entity in Lua/Entities/Entityname.lua
SWEP.Manufacturer = VNT_WEAPON_MANUFACTURER_REMINGTON -- (String) Gun company that makes this weapon
...
SWEP.Slot = VNT_WEAPON_BUCKETPOS_SHOTGUN -- (Integer) Bucket to place weapon in, 1 to 6
SWEP.SlotPos = VNT_WEAPON_SLOTPOS_SHOTGUN -- (Integer) Bucket position
...
SWEP.WorldModel = Model("models/jessev92/leadandgold/weapons/shotgun_w.mdl") -- (String) World model - w_*
...
SWEP.Primary.ClipSize = 2 -- (Integer) Size of a magazine
SWEP.Primary.DefaultClip = 2 -- (Integer) Default number of ammo you spawn with
SWEP.Primary.Ammo = "20gauge" -- (String) Primary ammo used by the weapon, bullets probably
SWEP.Primary.PureDmg = VNTCB.Ammo.a20GBuck[ 1 ] -- (Integer) Base damage, put one number here and the base will do the rest
...
SWEP.StrongPenetration = VNTCB.Ammo.a20GBuck[ 2 ] -- (Integer) Max penetration
SWEP.WeakPenetration = VNTCB.Ammo.a20GBuck[ 3 ] -- (Integer) Max wood penetration
SWEP.EffectiveRange = 15 -- (Integer) Effective range of the weapon in metres.
...
SWEP.Sounds = {
	["Primary"] = Sound( "Weapon_Shotgun.Double" ),
