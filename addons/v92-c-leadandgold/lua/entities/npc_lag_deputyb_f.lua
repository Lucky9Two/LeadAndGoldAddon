...
ENT.PrintName = "Blue Deputy Friendly"
...
if SERVER then
	function ENT:Initialize()
		...
		self.ent1:SetModel("models/jessev92/leadandgold/characters/deputy/npc_citizen.mdl" )
		self.ent1:SetSkin( 2 )
		...
		if GetConVarNumber( "npcg_squad_lag_Deputy" ) != 0	then		self.ent1:SetKeyValue( "SquadName", "LeadGoldRebSquad" )	end
