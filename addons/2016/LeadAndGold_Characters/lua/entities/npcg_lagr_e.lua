...
function ENT:Initialize()
	...
	self.ent1:SetModel("models/jessev92/leadandgold/characters/blaster_npccmb.mdl" )
	self.ent1:SetSkin( 2 )
	...
	self.ent2:SetModel("models/jessev92/leadandgold/characters/deputy_npccmb.mdl" )
	self.ent2:SetSkin( 2 )
	...
	self.ent3:SetModel("models/jessev92/leadandgold/characters/gunslinger_npccop.mdl" )
	self.ent3:SetSkin( 2 )
	...
	self.ent4:SetModel("models/jessev92/leadandgold/characters/trapper_npccmb.mdl" )
	self.ent4:SetSkin( 2 )
