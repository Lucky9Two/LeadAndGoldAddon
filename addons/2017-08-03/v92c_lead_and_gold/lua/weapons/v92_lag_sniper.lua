...
--	'Sniper'
--	.45-70 Government Sharps Rifle
------------------------------------------------------

AddCSLuaFile( )

SWEP.PrintName = "Sharps Rifle" -- (String) Printed name on menu
...
SWEP.WeaponName = "v92_lag_sniper" -- (String) Name of the weapon script
SWEP.WeaponEntityName = SWEP.WeaponName .. "_ent" -- (String) Name of the weapon entity in Lua/Entities/Entityname.lua
SWEP.Manufacturer = VNT_WEAPON_MANUFACTURER_SHARPS -- (String) Gun company that makes this weapon
...
SWEP.WorldModel = Model("models/jessev92/leadandgold/weapons/sniper_w.mdl") -- (String) World model - w_*
...
SWEP.Primary.Ammo = "4570gov" -- (String) Primary ammo used by the weapon, bullets probably
SWEP.Primary.PureDmg = VNTCB.Ammo.a4570Gov[ 1 ] -- (Integer) Base damage, put one number here and the base will do the rest
...
SWEP.StrongPenetration = VNTCB.Ammo.a4570Gov[ 2 ] -- (Integer) Max penetration
SWEP.WeakPenetration = VNTCB.Ammo.a4570Gov[ 3 ] -- (Integer) Max wood penetration
SWEP.EffectiveRange = 992 -- (Integer) Effective range of the weapon in metres.
