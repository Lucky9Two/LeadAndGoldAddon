...
ENT.PrintName = "Red Gang Friendly"
...
function ENT:Initialize()
	...
	self.ent1:SetModel("models/jessev92/leadandgold/characters/blaster/npc_citizen.mdl" )
	self.ent1:SetSkin( 2 )
	...
	self.ent2:SetModel("models/jessev92/leadandgold/characters/deputy/npc_citizen.mdl" )
	self.ent2:SetSkin( 1 )
	self.ent2:SetBodygroup( 1 , 1 )
	self.ent2:SetBodygroup( 2 , 1 )
	...
	self.ent3:SetModel("models/jessev92/leadandgold/characters/gunslinger/npc_citizen.mdl" )
	self.ent3:SetSkin( 2 )
	self.ent3:SetBodygroup( 1 , 0 )
	...
	self.ent4:SetModel("models/jessev92/leadandgold/characters/trapper/npc_citizen.mdl" )
	self.ent4:SetSkin( 2 )
	self.ent4:SetBodygroup( 1 , 0 )
	...
	if GetConVarNumber( "npcg_squad_lag_blaster" ) != 0	then		self.ent1:SetKeyValue( "SquadName", "LeadGoldRebSquad" )	end
	if GetConVarNumber( "npcg_squad_lag_deputy" ) != 0	then		self.ent2:SetKeyValue( "SquadName", "LeadGoldRebSquad" )	end
	if GetConVarNumber( "npcg_squad_lag_gunslinger" ) != 0	then	self.ent3:SetKeyValue( "SquadName", "LeadGoldRebSquad" )	end
	if GetConVarNumber( "npcg_squad_lag_trapper" ) != 0	then		self.ent4:SetKeyValue( "SquadName", "LeadGoldRebSquad" )	end
