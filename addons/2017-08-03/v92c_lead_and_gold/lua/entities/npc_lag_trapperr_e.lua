...
ENT.PrintName = "Red Trapper Enemy"
...
if SERVER then
	function ENT:Initialize()
		...
		self.ent1:SetModel("models/jessev92/leadandgold/characters/trapper/npc_combine.mdl" )
		self.ent1:SetSkin( 2 )
		self.ent1:SetBodygroup( 1 , 0 )
		self.ent1:SetBodygroup( 3 , 0 )
		self.ent1:SetKeyValue( "DontPickupWeapons", "1" )
		self.ent1:SetKeyValue( "additionalequipment", table.Random( weaponTrapper ) )
		...
		if GetConVarNumber( "npcg_squad_lag_Trapper" ) != 0	then
