...
function ENT:Initialize()
	...
	self.ent1:SetModel("models/jessev92/leadandgold/characters/blaster_npccit.mdl" )
	self.ent1:SetSkin( 2 )
	...
	self.ent2:SetModel("models/jessev92/leadandgold/characters/deputy_npccit.mdl" )
	self.ent2:SetSkin( 2 )
	...
	self.ent3:SetModel("models/jessev92/leadandgold/characters/gunslinger_npccit.mdl" )
	self.ent3:SetSkin( 2 )
	self.ent3:SetKeyValue( "DontPickupWeapons", GetConVarNumber("npcg_pickupguns") )
	self.ent3:SetKeyValue( "additionalequipment", table.Random( _WEPGS ) )
	...
	self.ent4:SetModel("models/jessev92/leadandgold/characters/trapper_npccit.mdl" )
	self.ent4:SetSkin( 2 )
